...
export function getRelocatedReviewPresetConfig() {
    return {
        ...
        description: 'Automatically detects watermark position and cleans up with AI model without manual tuning.',
...
export function getStandardAutoPresetConfig() {
    return {
        id: 'standard-auto',
        label: 'AI Auto Processing',
        description: 'Uses local AI model by default to process bottom-right Gemini/Veo watermarks.',
        alphaGain: DEFAULT_AUTO_ALPHA_GAIN,
        adaptiveAlpha: false,
        highQualityCleanup: DEFAULT_HIGH_QUALITY_CLEANUP,
